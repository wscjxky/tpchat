...
class AccessController extends Controller
{
    ...
    {
        $url='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxfdf007a79f182aed&redirect_uri=http://www.jianpianzi.com/tpchat/index.php/home/access/checkauth&response_type=code&scope=snsapi_base&state=1#wechat_redirect';
        if(IS_POST){
            $evidence=I('post.evidence');
            $result=M('evidence')->where(array('evidence'=>$evidence))->find();
            $success_url="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxfdf007a79f182aed&redirect_uri=http://www.jianpianzi.com/tpchat/index.php/Chat/User/registerinfo?evidence_id=$result[evidence_id]&response_type=code&scope=snsapi_base&state=1#wechat_redirect";
        ...
        session('course_id',I('get.course_id'));
...
<script>
  ...
  wx.ready(function () {
          ...
          wx.onMenuShareTimeline({
              ...
              link: \'http://www.jianpianzi.com/tpchat/index.php/Chat/index/course/courseid/12/aid/'.$openArr["openid"]
           .'\',
