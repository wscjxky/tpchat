...
<body ontouchstart style="-webkit-font-smoothing:">
<div class="weui-panel__bd"  >
    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div  class="weui-media-box weui-media-box_appmsg" style='padding: 5px'>
        <img style='width: 85px;height: 65px;vertical-align: top'  src="<?php echo ($v["image"]); ?>">
        <div class="weui-media-box__bd">
            ...
            <p style="visibility: hidden " class="weui-media-box__desc"  > a
            </p>
        </div>
