...
<div class= "weui-form-preview ">
    <div class= "weui-form-preview__hd ">
        ...
        <em class= "weui-form-preview__value " id="totalprice" style=" text-decoration:line-through;">100</em>
    </div>
    ...
    <div class= "weui-form-preview__ft ">
        <a  class= "weui-form-preview__btn weui-form-preview__btn_primary " onclick="submit()">确认订单</a>
    </div>
</div>
    ...
    function submit() {
        ...
        $.ajax({
            ...
            success : function(data){
                console.log(data);
                if(data){
                    window.location.href='/tpchat/index.php/home/jspay?trade_id='+data;
                    console.log(data);
                }else{
                    console.log(data);
                }
