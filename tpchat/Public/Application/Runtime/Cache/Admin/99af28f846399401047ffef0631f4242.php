                    ...
                    <form action="/tpchat/index.php/Admin/Video/video_info?id=41" method="post" enctype="multipart/form-data">
                        ...
                        <?php if($act == 'refuse' ): ?><table class="table table-bordered table-striped">
                            ...
                            <table class="table table-bordered table-striped" STYLE="text-align: center">
                                ...
                                <tr>
                                    <th >显示链接:</th>
                                    <td><input value="<?php echo ($data["confirm_url"]); ?>"  type="text" class="form-control" name="confirm_url" ></td>
                                </tr>
                                <tr>
                                    <th >平台描述:</th>
                                    <td><input value="<?php echo ($data["admin_desc"]); ?>"  type="text" class="form-control" name="admin_desc" ></td>
                                </tr>
                                <tr>
