...
//        $.ajax({
//            type: 'post',
//            url: "/tpchat/index.php/Chat/Index/sortcourse",
//            data: {
//                type: 'address',
//                x: x,
//                y: y
...
//                window.location.href="/tpchat/index.php/Chat/Index/sortcourse?type=address&x="+x+"&y="+y;
        ...
        $(".select_category").change(function() {
            console.log($(this).val());
                $.ajax({
                    type: 'post',
                    url: "/tpchat/index.php/Chat/Index/sortCategory",
                    data: {
    ...
    <div class="weui-tab">
        <div class="weui-navbar">
            <div class="weui-navbar__item weui-bar__item--on" href="#tab1">
                <img class="tabimage" src="<?php echo (IMG_URL); ?>专题讲座down.png">
                    <span>专题活动</span>

            </div>
            <div class="weui-navbar__item" href="#tab2">
                <img class="tabimage" src="<?php echo (IMG_URL); ?>实践课堂nor.png">
                    <span>实践课程</span>


            </div>
            <div class="weui-navbar__item" href="#tab3">
                <img class="tabimage" src="<?php echo (IMG_URL); ?>游学活动nor.png">
                    <span>游历游学</span>
            </div>
