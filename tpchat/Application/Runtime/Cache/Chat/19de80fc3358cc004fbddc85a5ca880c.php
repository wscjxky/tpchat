                ...
                if(data) {
                    ...
                    if($('#eachprice').text()=='0'){
                        $.alert({
                            ...
                            onOK: function () {
                                window.location.href='http://www.cunpianzi.com/tpchat/index.php/Chat/user/tradeinfo?trade_id='+data;
                            }
                        });

                    }
                    else{
                        window.location.href='http://www.cunpianzi.com/tpchat/index.php/home/jspay?trade_id='+data;
                    }
                }else{
                    console.log(data);
                }
