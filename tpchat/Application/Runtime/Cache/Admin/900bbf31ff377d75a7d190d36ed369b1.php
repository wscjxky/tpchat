...
<div class="page-header" style="">
    <h1>发送网站消息<small>提示 <i class="fa fa-lightbulb-o"></i></small></h1>
</div>
<form method="post" action="/tpchat/index.php/Admin/User/sendLog" enctype="multipart/form-data"  style="margin-left: 10%" >
    ...
    <div class="ncap-form-default tab_div_1" >
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <input type="text" value=""  style="width:500px" placeholder="http://或者https://" name="link" >
            </dd>
        </dl>
