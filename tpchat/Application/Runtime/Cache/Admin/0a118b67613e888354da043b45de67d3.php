...
<script>
    ...
    function generateqr(obj) {
            if($(obj).attr('data-type')=='course'){
                ...
                $('#qrcode').qrcode("http://www.cunpianzi.com/tpchat/index.php/chat/index/course?courseid="+$(obj).attr('data-id')); //任意字符串
                layer.open({
                    type: 1,
                    title:'课程码课程编号：',
                    closeBtn: 0,
                ...
                $('#qrcode').qrcode("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxfdf007a79f182aed&redirect_uri=http://www.cunpianzi.com/tpchat/index.php/home/access/checkauth&response_type=code&scope=snsapi_info&state=1#wechat_redirect"); //任意字符串
                layer.open({
...
<table class="table table-hover table-condensed table-striped table-bordered">
    ...
    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($v["course_id"]); ?>">
            ...
            <td ><?php echo ($v["big_category"]); ?></td>
            <td ><?php echo ($v["small_category"]); ?></td>
