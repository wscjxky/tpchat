...
//            var_dump(session('openid'));
        ...
        $this->assign('trade_url',$weObj->getOauthRedirect("http://www.cunpianzi.com/tpchat/index.php/Chat/index/trade?course_id=$courseid&aid=$aid"));
...
//        http://www.cunpianzi.com/tpchat/index.php/Chat/trade?course_id=12&aid=&code=0011Fgud1gSwwv057xsd1a0xud11FguL&state=
        //重新获取没有注册的用户信息
...
<script>
  ...
  wx.ready(function () {
  var url=\'http://www.cunpianzi.com/tpchat/index.php/Chat/index/course?courseid='.$courseid.'&aid='.session('openid').'\';
