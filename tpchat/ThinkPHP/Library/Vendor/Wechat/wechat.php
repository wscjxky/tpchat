...
class Wechat
{
	...
	{
	    $options=array(
            'appid'=>'wxfdf007a79f182aed', //填写高级调用功能的app id
            'appsecret'=>'aca79d612024f4ea47b8665b66358273' ,//填写高级调用功能的密钥
            'token'=>'weixin1', //填写你设定的key
            'encodingaeskey'=>'FWgzRR8pgddJ2UiLT8eEZ1W6ir9eaULVzxTufxIPOjU' //填写加密用的EncodingAESKey，如接口为明文模式可忽略
        );
...
<Nonce><![CDATA[%s]]></Nonce>
	 ...
	 */
	public function getJsSign($timestamp=0, $noncestr='', $appid=''){
