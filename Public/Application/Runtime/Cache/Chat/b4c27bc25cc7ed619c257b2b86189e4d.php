...
<div class="weui-panel__bd" style="margin-top: 15%;margin-bottom: 15%">
    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><a href="" class="weui-media-box weui-media-box_appmsg">
            <div class="weui-media-box__bd">
                <h4 class="weui-media-box__title"><?php echo ($v["video_title"]); ?></h4>
                <p class="weui-media-box__desc">视频链接：<?php echo ($v["video_url"]); ?></p>
                <p class="weui-media-box__desc">视频分类：<?php echo ($v["video_category"]); ?></p>

                <p class="weui-media-box__desc" >视频简述:<?php echo ($v["user_desc"]); ?></p>
