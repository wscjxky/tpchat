...
<div class="page-title"  >
    <h2><span>提现</span><a href="javascript:history.go(-1)" style="top: 30%;" class="arrow-left backpage"></a></h2>
</div>
...
<a style="position:fixed ;bottom:0 ; width: 100%" href="javascript:cash_submit();" class="weui-btn weui-btn_primary open-popup" data-target="#full">提        现</a>
