...
<script src="<?php echo (JS_URL); ?>layer.min.js"  type="text/javascript"></script>
...
<script>
    ...
    function generateqr(obj) {
            if($(obj).attr('data-type')=='course'){
                ...
                $('#qrcode').qrcode("http://www.jianpianzi.com/tpchat/index.php/home/access/checkauth?course_id="+$(obj).attr('data-id')); //任意字符串
                layer.open({
                    type: 1,
                ...
                $('#qrcode').qrcode("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxfdf007a79f182aed&redirect_uri=http://www.jianpianzi.com/tpchat/index.php/home/access/checkauth?course_id="+$(obj).attr('data-id')+"&response_type=code&scope=snsapi_base&state=1#wechat_redirect"); //任意字符串
                layer.open({
...
<table class="table table-hover table-condensed table-striped table-bordered">
    <div  style="margin-top: 50px">    <a href=""><button type="button" class="btn btn-info">搜索</button></a>
