...
<div class="page" style="  margin-left:10%">
    ...
    <form method="post" action="<?php echo U('Admin/Admin/articleHandle');?>" enctype="multipart/form-data"  >
        <div class="ncap-form-default tab_div_1">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input  value="<?php echo ($data["url"]); ?>"  placeholder="6-13"  name="age_limit" />
            ...
            <dl class="row">
                <dt class="tit">
                    <label >封面图片上传（jpg.png.jpgg.gif最好不超过3145728字节（3M）尺寸：长与宽同，最小60px*60px）</label>
                </dt>
                <dd class="opt">
