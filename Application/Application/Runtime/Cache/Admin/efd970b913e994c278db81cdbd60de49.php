...
<div class="page" style="  margin-left:10%">
    ...
    <form method="post" action="<?php echo U('Admin/Module/tutorialHandle');?>" enctype="multipart/form-data"  >
        <div class="ncap-form-default tab_div_1">
            ...
            <input style="display: none" value="<?php echo ($data["tutorial_id"]); ?>"   name="id" />
