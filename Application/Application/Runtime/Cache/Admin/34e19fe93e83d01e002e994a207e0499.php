...
<a href="tutorial_info" style="position:absolute;float: left;margin-top: 60px" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>添加教程</a>
            ...
            <div class="col-sm-12">
                <table id="list-table" class="table table-bordered table-striped dataTable">
                    ...
                    <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr role="row" >
                            <td><?php echo ($vo["tutorial_id"]); ?></td>
                            <td><?php echo ($vo["title"]); ?></td>
                            <td><?php echo ($vo["content"]); ?></td>
                            <td><img style="width: 100px;height:100px;" src="<?php echo (SHOW_URL); echo ($vo["image"]); ?>"/></td>
                            <td><?php echo ($vo["url"]); ?></td>
                            <td>
                                <a class="btn btn-primary"  href="tutorial_info?id=<?php echo ($vo["tutorial_id"]); ?>"><i class="fa fa-pencil"></i></a>

                                <a class="btn btn-danger" data-id="<?php echo ($vo["tutorial_id"]); ?>" data-act="del"  data-url="<?php echo U('Module/tutorialHandle');?>" onclick="delfunc(this)"><i class="fa fa-trash-o"></i></a>
                            </td>
