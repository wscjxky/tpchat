                            ...
                            <table class="table table-bordered table-striped" STYLE="text-align: center">
                                ...
                                <tr>
                                    ...
                                    <select id="selector" name="activity_title" class="select">
                                        <?php if(is_array($activitys)): $i = 0; $__LIST__ = $activitys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["title"]); ?>"><?php echo ($v["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
