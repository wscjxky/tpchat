...
<head>
    ...
    <link href="/tpchat/Public/font-awesome/css/font-awesome.css" rel="stylesheet" type="text/css" />
    <link href="/tpchat/Public/timepicker/bootstrap.css" rel="stylesheet" media="screen">
    <link href="/tpchat/Public/timepicker/bootstrap-datetimepicker.css" rel="stylesheet" media="screen">
    <style type="text/css">
...
<div class="page" style="  margin-left:10%">
    ...
    <form method="post" action="/tpchat/index.php/Admin/Course/addcourse" enctype="multipart/form-data"  >
        ...
        <div class="ncap-form-default tab_div_1">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <textarea   value="<?php echo ($data["desc"]); ?>" placeholder="不超过128字" name="desc" rows="5" cols="5"  style="width: 300px"></textarea>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                ...
                <dd class="opt">
                    <div class="form-group">
                        <div class="input-group date form_datetime col-md-5" data-date="1979-09-16T05:25:07Z" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
                            <input class="form-control" size="16" type="text"  name="starttime"  value="<?php echo ($data["starttime"]); ?>" >
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="form-group">
                        <div class="input-group date form_datetime col-md-5" data-date="1979-09-16T05:25:07Z" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
                            <input class="form-control" size="16" type="text" value="<?php echo ($data["endtime"]); ?>" name="endtime" >
                            <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                            <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                        </div>
                    </div>                </dd>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input  value="<?php echo ($data["phone"]); ?>"  placeholder=""  name="phone" />
                    <span  class="err" style="color:#F00; display:none;"></span>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <input  value="<?php echo ($data["is_activity"]); ?>"  placeholder="1或0"  name="is_activity" />
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                    <label for="">课程内容（图片宽度不能超过340px）</label>
                </dt>
...
<script>
    ...
    <script type="text/javascript" src="./tpchat/Public/timepicker/jquery-1.8.3.js" charset="UTF-8"></script>
    <script type="text/javascript" src="/tpchat/Public/timepicker/bootstrap.js"></script>
    <script type="text/javascript" src="/tpchat/Public/timepicker/bootstrap-datetimepicker.js" charset="UTF-8"></script>
    <script type="text/javascript" src="/tpchat/Public/timepicker/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
