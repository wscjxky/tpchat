...
//        $input->SetTotal_fee((int)$data['final_price']*100);
        ...
        $input->SetNotify_url("http://www.jianpianzi.com/tpchat/example/notify.php");
        ...
        echo sprintf('
                        ...
                        WeixinJSBridge.invoke(
                            ...
                            function(res){
                                WeixinJSBridge.log(res.err_msg);
           				           window.location.href="http://www.jianpianzi.com/tpchat/index.php/home/result"; }
                                                )
                    }
            ...
            </html>', $jsApiParameters, $editAddress);
        $this->display();
    }
