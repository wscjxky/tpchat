...
class AccessController extends Controller
{
    ...
    public function checkAuth()
    {
        ...
        if(IS_POST){
            ...
            $success_url="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxfdf007a79f182aed&redirect_uri=http://www.jianpianzi.com/tpchat/index.php/Chat/User/registerinfo?evidence_id=$result[evidence_id]&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect";
