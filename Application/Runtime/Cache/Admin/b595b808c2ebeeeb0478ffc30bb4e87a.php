...
<div class="admincp-container unfold">
    <div class="admincp-container-left">
        ...
        <div id="admincpNavTabs_index" class="nav-tabs" style="display: block!important;">
            ...
            <dl>
                ...
                <dd class="sub-menu">
                    <ul>
                        ...
                        <li><a href="javascript:void(0);" data-param="category|Course">课程分类</a></li>

                        <li><a href="javascript:void(0);" data-param="index|Activity">活动列表</a></li>
            ...
            <dl>
                <dt>
                    <a href="javascript:void(0);"><span class="ico-system-3"></span><h3>交互</h3>
                </a>
                </dt>
                <dd class="sub-menu">
                    <ul>
            ...
            <dl>
                ...
                <dd class="sub-menu">
                    <ul>
                        ...
                        <li><a href="javascript:void(0);" data-param="article|Module">热点报道</a></li>
                        <li><a href="javascript:void(0);" data-param="tutorial|Module">在线教程</a></li>
                        <li><a href="javascript:void(0);" data-param="activity|Module">活动推送</a></li>

                        <li><a href="javascript:void(0);" data-param="index|Video">视频管理</a></li>
