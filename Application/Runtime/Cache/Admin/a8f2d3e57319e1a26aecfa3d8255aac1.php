...
<a href="addbanner" style="position:absolute;float: left;margin-top: 60px" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>添加轮播图</a>
                ...
                <table id="list-table" class="table table-bordered table-striped dataTable">
                    ...
                    <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr role="row" >
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger" data-id="<?php echo ($vo["banner_id"]); ?>" data-act="del"  data-url="<?php echo U('Module/bannerHandle');?>" onclick="delfunc(this)"><i class="fa fa-trash-o"></i></a>
