...
<script>
    ...
    function generateqr(obj) {
            if($(obj).attr('data-type')=='course'){
                ...
                $('#qrcode').qrcode("https://www.jianpianzi.com/tpchat/index.php/home/access/checkauth?course_id="+$(obj).attr('data-id')); //任意字符串
                layer.open({
                    type: 1,
                ...
                $('#qrcode').qrcode("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxfdf007a79f182aed&redirect_uri=https://www.jianpianzi.com/tpchat/index.php/home/access/checkauth?course_id="+$(obj).attr('data-id')+"&response_type=code&scope=snsapi_base&state=1#wechat_redirect"); //任意字符串
                layer.open({
