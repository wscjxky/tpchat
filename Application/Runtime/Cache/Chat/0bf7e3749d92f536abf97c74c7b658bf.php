...
<form   style="margin: 10%;"  class="weui-cells weui-cells_form"  method="post"   action="" target="iframe" >
    ...
    <div class="weui-cell" >
        ...
        <input  value="<?php echo ($user["username"]); ?>" name="username" id="video_title"  type="text" />
    </div>
    </div>
    ...
    <div class="weui-cell">
        ...
        <div class="weui-cell__bd">
            <input name='phone'value="<?php echo ($user["phone"]); ?>"  id='phone' class="weui-input" type="tel" placeholder="请输入手机号">
                ...
                success: function (data) {
                    if(data=='error'){
                        ...
                        $.alert({
                            ...
                            onOK: function () {
//                                window.location.href = '/tpchat/index.php/Chat/index/trade?course_id=' + data;
