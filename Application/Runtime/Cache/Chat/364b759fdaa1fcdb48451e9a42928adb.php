...
<script type="text/javascript">
    $(document).ready(function(){
        $("#qrcode").qrcode("https://www.jianpianzi.com/tpchat/index.php/chat/index/course?courseid=<?php echo ($data["course_id"]); ?>&aid=<?php echo ($aid); ?>").css("left","16%").css("top","20%");
    });
    function qrcode() {
        //二维码消失
...
//        console.log("https://www.jianpianzi.com/tpchat/index.php/chat/index/course?title=<?php echo ($data["title"]); ?>&openid=<?php echo ($openid); ?>");
    }
    }
    function showAlert() {
        $.alert("您已经参加过本次活动了。");
...
<div class="weui-tabbar" style="text-align: center;position:fixed ;background:url('https://www.jianpianzi.com/tpchat/Public/img/nav_bar.png')" >
