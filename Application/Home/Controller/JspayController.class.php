...
//        $input->SetTotal_fee(1);
        ...
        $input->SetNotify_url("https://www.jianpianzi.com/tpchat/example/notify.php");
                            ...
                            function(res){
                                WeixinJSBridge.log(res.err_msg);
                                 if(res.err_msg == "get_brand_wcpay_request:ok" ){
                                         window.location.href="https://www.jianpianzi.com/tpchat/index.php/home/result?trade_id=%s"; 
