...
//        }
        ...
        switch($type) {
            case \Wechat::MSGTYPE_TEXT:
                switch ($content){
                    case "活动":
                        $weObj->text("<a href='https://www.jianpianzi.com/tpchat/index.php/Chat/article'>活动详情</a>")->reply();
                        break;
                    case "买":
                        $weObj->text('点击底部菜单栏中间的筑影课程，就可以直接进入购买页啦！')->reply();
                        break;
                    case "作品":
                        $weObj->text('<a href="https://www.jianpianzi.com/tpchat/index.php/Chat/product">作品集锦</a>')->reply();
                        break;
                    case "订":
                        $weObj->text('<a href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxfdf007a79f182aed&redirect_uri=https://www.jianpianzi.com/tpchat/index.php/chat/user/trade&response_type=code&scope=snsapi_userinfo&state=1&connect_redirect=1#wechat_redirect">我的订单</a>')->reply();
                        break;
                    case "我":
                        $weObj->text('<a href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxfdf007a79f182aed&redirect_uri=https://www.jianpianzi.com/tpchat/index.php/chat/user&response_type=code&scope=snsapi_userinfo&state=1&connect_redirect=1#wechat_redirect">我的信息</a>')->reply();
                        break;
                    default:
            ...
            case \Wechat::MSGTYPE_EVENT:
                if ($event['key']=='aboutus'){
                    ...
                    $weObj->text("感谢您的关注！筑影天地与各知名电视台、传媒高校一起，为5-13岁的青少儿童，量身打造文化传媒领域的实践培训基地，帮助孩子们建立自信，提升综合素养，锻炼实践和创新能力。您可以进入<a href='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxfdf007a79f182aed&redirect_uri=https://www.jianpianzi.com/tpchat/index.php/chat&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect'>筑影学堂</a>挑选专业的实训课程，教孩子们沟通表达、组织活动、摄影摄像、制作视频和策划校园栏目等，这些课程由专业老师教授，形式新颖，内容实用。您可以进入<a  href='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxfdf007a79f182aed&redirect_uri=https://www.jianpianzi.com/tpchat/index.php/Chat/article&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect'>热点聚焦</a>，阅读丰富多彩的文章，学习有用的文化传媒知识，了解最新的传媒教育动态，欣赏精彩的视频影像。您也可以进入<a href='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxfdf007a79f182aed&redirect_uri=https://www.jianpianzi.com/tpchat/index.php/Chat/product&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect'>作品集锦</a>，这些都是学堂孩子们培训后的成果展现，他们拍成了视频提交上来，等着你观看、点赞和评论，别忘了这里还经常举行比赛活动哦，点赞最多的孩子会获得丰厚的奖品。看累了，您就进入<a href='http://www.ximalaya.com/zhubo/93586430/'>筑影FM</a>感受一下，用耳朵倾听老师们的现场教学录音，总之这里有很多让你感觉有趣的东西，快来体验吧!")->reply();
